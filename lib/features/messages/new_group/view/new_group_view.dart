...
class NewGroupView extends GetView<NewGroupViewModel> {
  ...
  Widget build(BuildContext context) {
    return Container(
      // The margin ensures the top area of the dialog is open to show the backdrop blur
      ...
      child: ClipRRect(
        ...
        child: Scaffold(
          ...
          // REMOVED SafeArea here so it doesn't try to stretch or override the Container heights
          body: Column(
            children: [
              const SizedBox(height: 16), // Adjusted spacing slightly for a clean header layout
              ...
              Expanded(
                child: Obx(() {
                  ...
                  return ListView(
                    padding: const EdgeInsets.fromLTRB(16, 0, 16, 16), // Added bottom padding for a safer scroll end
                    children: [
                      if (isSearching)
                        Padding(
